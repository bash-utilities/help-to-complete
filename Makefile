...
# Install/Uninstall make script for bash-utilities/help-to-complete
...
completion: ## Builds tab completion Bash configuration file for help-to-complete
	"$(ROOT_DIRECTORY_PATH)/help-to-complete" --executable "$(ROOT_DIRECTORY_PATH)/help-to-complete" --completion-dir "$(ROOT_DIRECTORY_PATH)/bash-completion" --clobber
